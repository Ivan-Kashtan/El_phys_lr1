...
# s_130 = Spacer(0, 120)
s_150 = Spacer(0, 150)
tp = Paragraph('Лабораторная работа № 1', style=s_c_t)
title = Paragraph('Исследование переходных процессов в цепях с сосредоточенными параметрами', style=s_c_t_b)
var = Paragraph('Вариант 27', style=s_c_t)
